...
export const timeline: Milestone[] = [
  {
    ...
    location: "Tanzania",
    body: "My innovation journey bergan long before I entered primary school. As a child, I was naturally curious about how things worked and enjoyed creating different objects using locally available  .",
