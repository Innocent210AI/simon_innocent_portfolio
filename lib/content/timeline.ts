...
export const timeline: Milestone[] = [
  ...
  },
  {
    ...
    location: "Tanzania",
    body: "Before starting formal education, I spent much of my time exploring, building, andexperimenting with simple materials around me. I enjoyed creating objects and finding ways to  Toy cars, miniature houses, and household appliance models built from wood and scrap. The model houses got simple electrical connections that simulated residential wiring — my first contact with circuits as something you build rather than draw.",
