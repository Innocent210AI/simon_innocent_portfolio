...
export const metadata: Metadata = {
  title: 'About',
  description:
    'Innocent Simon is an innovator, STEM educator, and electronics technologist building practical solutions through electronics, robotics, engineering, and entrepreneurship.',
}
