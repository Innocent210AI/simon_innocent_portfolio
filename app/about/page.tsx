        ...
        <div className="shell relative grid gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <Reveal delay={120} className="mt-8 space-y-5 body-lg text-mist/75">
              ...
              <p>
                My STEM and innovation journey has also provided international opportunities. In 2022, I received the Clare Elwell Scholarship as a Young Scientist for Africa (YoSA) to participate in the 63rd London International Youth Science Forum (LIYSF) and represent {" "} <a href="https://projektinspire.co.tz/" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline hover:text-blue-800" > ProjeKt Inspire </a>, Tanzania, and Africa. I also participated in the Global Innovation Field Trip (GIFT) from 2021 to 2023, presenting topics related to innovation, robotics, artificial intelligence, STEM, and climate action.
              </p>
              <p>
